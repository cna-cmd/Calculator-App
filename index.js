      ...
      Enter your choice: `,
            (choice) => {
                if (!operations.validateNumbers(x, y)) {
                    ...
                    switch (choice) {
                        case '1':
                            console.log(`The sum of ${x} and ${y} is ${operations.sum(x, y)}.`)
                            break
                        case '2':
                            console.log(
                                `The difference of ${x} and ${y} is ${operations.subtraction(x, y)}.`
                            )
                            break
                        case '3':
                            console.log(
                                `The product of ${x} and ${y} is ${operations.multiplication(x, y)}.`
                            )
                            break
                        case '4':
                            console.log(
                                `The quotient of ${x} and ${y} is ${operations.split(x, y)}.`
                            )
                            break
                        default:
                            console.log(
